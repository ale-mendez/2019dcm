...
\end{equation*}
\begin{figure}
  \includegraphics[width=0.65\textwidth]{figures/dim/effcharge.eps}
\end{figure}
...
%   \end{array}$};
  \node (nconf) at (eqCI) [xshift=3.5cm,yshift=1cm]
  {\small\it Número de configuraciones};
  \draw [arrow, bend right=-30] 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Influencia de $\lambda_{nl}$}
