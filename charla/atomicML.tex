...
+ \frac{l(l+1)}{2 r} - \varepsilon_{nl} \,r $};
\end{tikzpicture}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Estructura atómica}

\begin{equation*}
\left[ \frac{1}{2} \frac{d^2}{dr^2} - \frac{l(l+1)}{2r^2} 
+ V_{\mbox{\scriptsize eff}}(r) + \epsilon_{nl} \right] P_{nl}(r)=0\,,
\end{equation*}

\medskip
Model potential:
\begin{itemize}
 \item Thomas–Fermi–Dirac–Amaldi [13]. 
 \item Slater-Type-Orbital potential of Burgess [23] 
 \item Self-consistent configuration average potential of Cowan [7]
\end{itemize}
