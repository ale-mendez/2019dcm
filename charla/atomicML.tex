...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node<1> (func) {\includegraphics[width=0.9\textwidth]{figures/gp/funcion.eps}};
  \node<2> (prior) {\includegraphics[width=0.9\textwidth]{figures/gp/initer/example.eps}};
  \node<3> (max1) {\includegraphics[width=0.9\textwidth]{figures/gp/eval1/example.eps}};
  \node<4> (max2) {\includegraphics[width=0.9\textwidth]{figures/gp/eval2/example.eps}};
  \node<5> (max3) {\includegraphics[width=0.9\textwidth]{figures/gp/eval3/example.eps}};
  \node<6> (max4) {\includegraphics[width=0.9\textwidth]{figures/gp/eval4/example.eps}};
  \node<7> (max5) {\includegraphics[width=0.9\textwidth]{figures/gp/eval5/example.eps}};
  \node<8> (max6) {\includegraphics[width=0.9\textwidth]{figures/gp/eval6/example.eps}};
  \node<9> (max7) {\includegraphics[width=0.9\textwidth]{figures/gp/eval7/example.eps}};
  \node<10> (max9) {\includegraphics[width=0.9\textwidth]{figures/gp/eval8/example.eps}};
  \node<11> (max10) {\includegraphics[width=0.9\textwidth]{figures/gp/eval9/example.eps}};
\end{tikzpicture}
